    ...
    <>
      ...
      <Bottom>
        <div className="bottom-link" style={{ display: "float" }}>
          <img src={images["stars.svg"]} alt="github" style={{ width: 20 }} />Disponible pour PC, Mac et Linux sur<a href="https://github.com/rodolphe37/install-games-repository/blob/master/README.md" title="Jeux disponibles pour Windows, Mac et Linux" target="_blank" rel="noopener noreferrer">github</a>{" "}
